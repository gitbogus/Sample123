...
function Test1()
{
  ...
  Browsers.Item("edge").RunOptions = "--user-data-dir=\\C:\\Users\\Default\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\\" --headless";
  //Runs a script routine.
  //Test_Chrome_Headless();
  //Runs a script routine.
  //Sample_Run_Browser();
  //Opens the specified URL in a running instance of the specified browser.
  Browsers.Item(btEdge).Navigate("https://v-portal-ui.vportaldev.koreabuild.com/login");
